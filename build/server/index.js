      ...
      children: [
        ...
        /* @__PURE__ */ jsx("section", { className: "flex flex-1 justify-start my-12 px-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center max-w-3xl w-full mx-auto", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "flex flex-1 flex-col items-center justify-center text-gray-800", children: "Développeur depuis maintenant 8 ans et à mon compte depuis 3 ans, j'ai une grande affinité avec le front-end et les tests bien fait. Pas full-stack mais touche à tout, je suis également à l'aise sur le développement mobile avec react-native et le développement backend Symfony / php." })
          ] })
        ] }) }),
        /* @__PURE__ */ jsx(
          "button",
